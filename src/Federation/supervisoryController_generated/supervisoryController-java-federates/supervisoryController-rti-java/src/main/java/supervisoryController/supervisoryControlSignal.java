...
public class supervisoryControlSignal extends ObjectRoot {
	...
	*/
	...
	private Attribute< Float > _modulationSignal =
	...
	*/
	public Object getAttribute( int datamemberHandle ) {
		...
		else if ( get_modulationSignal_handle() == datamemberHandle ) return new Float(get_modulationSignal());
	...
	protected boolean setAttributeAux( int param_handle, String val ) {
		...
		else if ( param_handle == get_modulationSignal_handle() ) set_modulationSignal( Float.parseFloat(val) );
	...
	protected SuppliedAttributes createSuppliedDatamembers( boolean force ) {
		...
		boolean isPublished = false;
			...
			if (  isPublished && _modulationSignal.shouldBeUpdated( force )  ) {
				datamembers.add( get_modulationSignal_handle(), Float.toString(get_modulationSignal()).getBytes() );
