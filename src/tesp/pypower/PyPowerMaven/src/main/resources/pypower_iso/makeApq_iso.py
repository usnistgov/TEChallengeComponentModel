...
from pypower_iso.idx_gen_iso import PC1, PC2, QC1MIN, QC1MAX, QC2MIN, QC2MAX

from pypower_iso.hasPQcap_iso import hasPQcap_iso


def makeApq_iso(baseMVA, gen):
    """Construct linear constraints for generator capability curves.
    ...
    ipqh = find( hasPQcap_iso(gen, 'U') )
    ipql = find( hasPQcap_iso(gen, 'L') )
