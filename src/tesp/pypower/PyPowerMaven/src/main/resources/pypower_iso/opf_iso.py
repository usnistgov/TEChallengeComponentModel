...
from pypower_iso.idx_bus_iso import MU_VMIN
from pypower_iso.idx_gen_iso import PG, QG, MU_QMIN, MU_PMAX, MU_PMIN
from pypower_iso.idx_brch_iso import PF, QF, PT, QT, MU_SF, MU_ST, MU_ANGMIN, MU_ANGMAX

from pypower_iso.ext2int_iso import ext2int_iso
from pypower_iso.opf_args_iso import opf_args2_iso
from pypower_iso.opf_setup_iso import opf_setup_iso
from pypower_iso.opf_execute_iso import opf_execute_iso
...
def opf_iso(*args):
    ...
    om = opf_setup_iso(ppc, ppopt)

    ##-----  execute the OPF  -----
    results, success, raw = opf_execute_iso(om, ppopt)

    ##-----  revert to original ordering, including out-of-service stuff  -----
    results = int2ext_iso(results)
