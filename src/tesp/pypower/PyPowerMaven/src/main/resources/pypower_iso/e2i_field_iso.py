...
from pypower_iso.e2i_data_iso import e2i_data_iso  #@UnusedImport
...
def e2i_field_iso(ppc, field, ordering, dim=0):
    ...
    exec('ppc%s = e2i_data_iso(ppc, ppc%s, ordering, dim)' % (key, key))
