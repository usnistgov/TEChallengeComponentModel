...
from pypower_iso._compat_iso import PY2
from pypower_iso.run_userfcn_iso import run_userfcn_iso

from pypower_iso.idx_bus_iso import MU_VMIN, VMIN
from pypower_iso.idx_gen_iso import PMIN, MU_PMAX, MU_PMIN, MU_QMIN, MU_QMAX, APF
from pypower_iso.idx_brch_iso import \
    MU_ST, MU_SF, BR_STATUS, PF, PT, QT, QF, ANGMAX, MU_ANGMAX
from pypower_iso.idx_area_iso import PRICE_REF_BUS
from pypower_iso.idx_cost_iso import MODEL, NCOST, PW_LINEAR, POLYNOMIAL
...
def savecase_iso(fname, ppc, comment=None, version='2'):
...
#            prefix = ''
        ...
        if 'userfcn' in ppc:
            run_userfcn_iso(ppc["userfcn"], 'savecase', ppc, fd, prefix)
