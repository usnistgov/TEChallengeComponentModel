...
from pypower_iso.d2Sbr_dV2_iso import d2Sbr_dV2_iso


def d2ASbr_dV2_iso(dSbr_dVa, dSbr_dVm, Sbr, Cbr, Ybr, V, lam):
    """Computes 2nd derivatives of |complex power flow|**2 w.r.t. V.
    ...
    Saa, Sav, Sva, Svv = d2Sbr_dV2_iso(Cbr, Ybr, V, diagSbr_conj * lam)
