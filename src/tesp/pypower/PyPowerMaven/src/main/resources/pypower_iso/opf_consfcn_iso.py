...
from pypower_iso.idx_gen_iso import GEN_BUS, PG, QG
from pypower_iso.idx_brch_iso import F_BUS, T_BUS, RATE_A

from pypower_iso.makeSbus_iso import makeSbus_iso
from pypower_iso.dSbus_dV_iso import dSbus_dV_iso
from pypower_iso.dIbr_dV_iso import dIbr_dV_iso
from pypower_iso.dSbr_dV_iso import dSbr_dV_iso
from pypower_iso.dAbr_dV_iso import dAbr_dV_iso


def opf_consfcn_iso(x, om, Ybus, Yf, Yt, ppopt, il=None, *args):
    """Evaluates nonlinear constraints and their Jacobian for OPF.
    ...
    ## rebuild Sbus
    Sbus = makeSbus_iso(baseMVA, bus, gen) ## net injected power in p.u.
    ...
    dSbus_dVm, dSbus_dVa = dSbus_dV_iso(Ybus, V)           ## w.r.t. V
    ...
    if nl2 > 0:
        ...
        df_dVa, df_dVm, dt_dVa, dt_dVm = \
                dAbr_dV_iso(dFf_dVa, dFf_dVm, dFt_dVa, dFt_dVm, Ff, Ft)
