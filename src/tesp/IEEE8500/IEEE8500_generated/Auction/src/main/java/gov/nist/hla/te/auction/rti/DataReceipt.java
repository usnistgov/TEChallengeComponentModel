...
public class DataReceipt extends C2WInteractionRoot {
    ...
    */
    public Object getParameter( String datamemberName ) {
        if ( "dataSent".equals(datamemberName) ) return new Integer(get_dataSent());
    ...
    protected boolean setParameterAux( String datamemberName, String val ) {
        boolean retval = true;
        if ( "dataSent".equals( datamemberName) ) set_dataSent( Integer.parseInt(val) );
    ...
    protected boolean setParameterAux( String datamemberName, Object val ) {
        boolean retval = true;
        if ( "dataSent".equals( datamemberName) ) set_dataSent( (Integer)val );
