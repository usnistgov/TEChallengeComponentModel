...
public class Meter extends ObjectRoot {
    ...
    */
    ...
    private static int _measured_real_energy_handle;
    ...
    */
    ...
    static {
        ...
        _datamemberNames.add("measured_real_energy");
        ...
        _datamemberTypeMap.put("measured_real_energy", "double");
        ...
        _allDatamemberNames.add("measured_real_energy");
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                ...
                _measured_real_energy_handle = rti.getAttributeHandle("measured_real_energy", get_handle());
        ...
        _datamemberNameHandleMap.put("ObjectRoot.Meter.measured_real_energy", _measured_real_energy_handle);
        ...
        _datamemberHandleNameMap.put(_measured_real_energy_handle, "measured_real_energy");
    ...
    */
    ...
    public String getAttributeName(int datamemberHandle) {
        ...
        else if (datamemberHandle == _measured_real_energy_handle) return "measured_real_energy";
    ...
    */
    ...
    public String toString() {
        return getClass().getName() + "("
                ...
                + "," + "measured_real_energy:" + get_measured_real_energy()
    ...
    */
    ...
    /**
    * Publishes the "measured_real_energy" attribute of the attribute's containing object
    * class for a federate.
    * Note:  This method only marks the "measured_real_energy" attribute for publication.
    * To actually publish the attribute, the federate must (re)publish its containing
    * object class.
    * (using &lt;objectClassName&gt;.publish( RTIambassador rti ) ).
    */
    public static void publish_measured_real_energy() {
        _publishAttributeNameSet.add( "measured_real_energy" );
    }

    /**
    * Unpublishes the "measured_real_energy" attribute of the attribute's containing object
    * class for a federate.
    * Note:  This method only marks the "measured_real_energy" attribute for unpublication.
    * To actually publish the attribute, the federate must (re)publish its containing
    * object class.
    * (using &lt;objectClassName&gt;.publish( RTIambassador rti ) ).
    */
    public static void unpublish_measured_real_energy() {
        _publishAttributeNameSet.remove( "measured_real_energy" );
    }

    /**
    * Subscribes a federate to the "measured_real_energy" attribute of the attribute's
    * containing object class.
    * Note:  This method only marks the "measured_real_energy" attribute for subscription.
    * To actually subscribe to the attribute, the federate must (re)subscribe to its
    * containing object class.
    * (using &lt;objectClassName&gt;.subscribe( RTIambassador rti ) ).
    */
    public static void subscribe_measured_real_energy() {
        _subscribeAttributeNameSet.add( "measured_real_energy" );
    }

    /**
    * Unsubscribes a federate from the "measured_real_energy" attribute of the attribute's
    * containing object class.
    * Note:  This method only marks the "measured_real_energy" attribute for unsubscription.
    * To actually unsubscribe to the attribute, the federate must (re)subscribe to its
    * containing object class.
    * (using &lt;objectClassName&gt;.subscribe( RTIambassador rti ) ).
    */
    public static void unsubscribe_measured_real_energy() {
        _subscribeAttributeNameSet.remove( "measured_real_energy" );
    }
    ...
    */
    ...
    protected Attribute< Double > _measured_real_energy =
            new Attribute< Double >(  new Double( 0 )  );

    /**
    * Set the value of the "measured_real_energy" attribute to "value" for this object.
    *
    * @param value the new value for the "measured_real_energy" attribute
    */
    public void set_measured_real_energy( double value ) {
        _measured_real_energy.setValue( value );
        _measured_real_energy.setTime( getTime() );
    }

    /**
    * Returns the value of the "measured_real_energy" attribute of this object.
    *
    * @return the value of the "measured_real_energy" attribute
    */
    public double get_measured_real_energy() {
        return _measured_real_energy.getValue();
    }

    /**
    * Returns the current timestamp of the "measured_real_energy" attribute of this object.
    *
    * @return the current timestamp of the "measured_real_energy" attribute
    */
    public double get_measured_real_energy_time() {
        return _measured_real_energy.getTime();
    }
    ...
    */
    public Meter( Meter Meter_var ) {
        ...
        set_measured_real_energy( Meter_var.get_measured_real_energy() );
    ...
    */
    public Object getAttribute( String datamemberName ) {
        ...
        else if ( "measured_real_energy".equals(datamemberName) ) return new Double(get_measured_real_energy());
    ...
    protected boolean setAttributeAux( String datamemberName, String val ) {
        ...
        else if ( "measured_real_energy".equals( datamemberName) ) set_measured_real_energy( Double.parseDouble(val) );
    ...
    protected boolean setAttributeAux( String datamemberName, Object val ) {
        ...
        else if ( "measured_real_energy".equals( datamemberName) ) set_measured_real_energy( (Double)val );
    ...
    protected SuppliedAttributes createSuppliedDatamembers(boolean force) {
        ...
        if (_publishAttributeNameSet.contains("measured_real_energy") && _measured_real_energy.shouldBeUpdated(force)) {
            datamembers.add( getAttributeHandle("measured_real_energy"), getAttribute("measured_real_energy").toString().getBytes() );
            _measured_real_energy.setHasBeenUpdated();
        }
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof Meter ) {
            ...
            _measured_real_energy = data._measured_real_energy;
