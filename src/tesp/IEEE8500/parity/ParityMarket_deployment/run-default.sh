...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/MarketReporting-${timestamp}.log -T "MarketReporting" -geometry 140x40+30+60 -e "mvn exec:java -P ExecJava,MarketReporting" &
waitUntilJoined MarketReporting 1
...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/ParitySystem-${timestamp}.log -T "ParitySystem" -geometry 140x40+90+120 -e "mvn exec:java -P ExecJava,ParitySystem" &
