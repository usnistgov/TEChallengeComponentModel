package gov.nist.hla.parity.parityclient;

import gov.nist.hla.parity.parityclient.rti.*;
...
public class ParityClientBase extends SynchronizedFederate {
    ...
    public ParityClientBase(FederateConfig config) throws Exception {
        ...
        // interaction pubsub
        EnterOrder.publish(getLRC());
        CancelOrder.publish(getLRC());
        OrderCanceled.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           OrderCanceled.get_handle(),
           SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED,
           SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED);
        OrderAccepted.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           OrderAccepted.get_handle(),
           SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED,
           SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED);
        OrderRejected.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           OrderRejected.get_handle(),
           SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED,
           SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED);
        OrderExecuted.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           OrderExecuted.get_handle(),
           SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED,
           SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED);
    ...
    public EnterOrder create_EnterOrder() {
        EnterOrder interaction = new EnterOrder();
        interaction.set_sourceFed(getFederateId());
        interaction.set_originFed(getFederateId());
        return interaction;
    }
    public CancelOrder create_CancelOrder() {
        CancelOrder interaction = new CancelOrder();
        interaction.set_sourceFed(getFederateId());
        interaction.set_originFed(getFederateId());
        return interaction;
    }
