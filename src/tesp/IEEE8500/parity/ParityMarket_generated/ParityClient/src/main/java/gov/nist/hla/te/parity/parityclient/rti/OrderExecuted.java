...
public class OrderExecuted extends ParitySystem {
    ...
    */
    public OrderExecuted( OrderExecuted OrderExecuted_var ) {
        ...
        set_orderId( OrderExecuted_var.get_orderId() );
    ...
    */
    public Object getParameter( String datamemberName ) {
        ...
        else if ( "matchNumber".equals(datamemberName) ) return new Long(get_matchNumber());
    ...
    protected boolean setParameterAux( String datamemberName, String val ) {
        ...
        else if ( "matchNumber".equals( datamemberName) ) set_matchNumber( Long.parseLong(val) );
    ...
    protected boolean setParameterAux( String datamemberName, Object val ) {
        ...
        else if ( "matchNumber".equals( datamemberName) ) set_matchNumber( (Long)val );
