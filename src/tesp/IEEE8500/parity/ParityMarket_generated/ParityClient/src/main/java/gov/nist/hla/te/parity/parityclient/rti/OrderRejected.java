package gov.nist.hla.te.parity.parityclient.rti;
...
public class OrderRejected extends ParitySystem {
    ...
    */
    public OrderRejected( OrderRejected OrderRejected_var ) {
        ...
        set_orderId( OrderRejected_var.get_orderId() );
    ...
    */
    public Object getParameter( String datamemberName ) {
        if ( "orderId".equals(datamemberName) ) return get_orderId();
    ...
    protected boolean setParameterAux( String datamemberName, String val ) {
        boolean retval = true;
        if ( "orderId".equals( datamemberName) ) set_orderId( val );
    ...
    protected boolean setParameterAux( String datamemberName, Object val ) {
        boolean retval = true;
        if ( "orderId".equals( datamemberName) ) set_orderId( (String)val );
