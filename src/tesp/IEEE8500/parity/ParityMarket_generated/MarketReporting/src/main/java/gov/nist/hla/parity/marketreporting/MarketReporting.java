package gov.nist.hla.parity.marketreporting;

import gov.nist.hla.parity.marketreporting.rti.*;
...
public class MarketReporting extends MarketReportingBase {
    ...
    private void checkReceivedSubscriptions() {
        ...
        while ((interaction = getNextInteractionNoWait()) != null) {
            ...
            else if (interaction instanceof Version) {
                handleInteractionClass((Version) interaction);
            }
    ...
    private void handleInteractionClass(Version interaction) {
        ///////////////////////////////////////////////////////////////
        // TODO implement how to handle reception of the interaction //
        ///////////////////////////////////////////////////////////////
    }
