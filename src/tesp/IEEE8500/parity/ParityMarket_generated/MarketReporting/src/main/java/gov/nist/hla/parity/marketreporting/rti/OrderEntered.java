...
public class OrderEntered extends ParityReporting {
    ...
    */
    ...
    protected static void init(RTIambassador rti) {
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParityReporting.OrderEntered.messageType", _messageType_handle);
    ...
    */
    public OrderEntered( OrderEntered OrderEntered_var ) {
        ...
        set_timeStamp( OrderEntered_var.get_timeStamp() );
