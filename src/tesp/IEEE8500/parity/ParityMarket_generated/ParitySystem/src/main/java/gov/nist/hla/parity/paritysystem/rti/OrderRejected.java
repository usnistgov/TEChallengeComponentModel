...
/**
* Implements InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected
*/
public class OrderRejected extends ParitySystem {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the OrderRejected interaction class with default parameter values.
    */
    ...
    /**
    * Returns the handle (RTI assigned) of the OrderRejected interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the OrderRejected interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the OrderRejected interaction class.
    *
    ...
    * OrderRejected interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected", OrderRejected.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected");
        _classHandleSimpleNameMap.put(get_handle(), "OrderRejected");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected.messageType", _messageType_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected.orderId", _orderId_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected.reason", _reason_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected.sourceFed", _sourceFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected.timeStamp", _timeStamp_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.ParitySystem.OrderRejected.userName", _userName_handle);
    ...
    /**
    * Publishes the OrderRejected interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the OrderRejected interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the OrderRejected interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the OrderRejected interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the OrderRejected interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the OrderRejected interaction class).
    ...
    */
    ...
    protected OrderRejected( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected OrderRejected( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the OrderRejected interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new OrderRejected interaction class instance
    */
    public OrderRejected( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #OrderRejected( ReceivedInteraction datamemberMap )}, except this
    * new OrderRejected interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new OrderRejected interaction class instance
    * @param logicalTime timestamp for this new OrderRejected interaction class
    * instance
    */
    public OrderRejected( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new OrderRejected interaction class instance that is a duplicate
    * of the instance referred to by OrderRejected_var.
    *
    * @param OrderRejected_var OrderRejected interaction class instance of which
    * this newly created OrderRejected interaction class instance will be a
    * duplicate
    */
    public OrderRejected( OrderRejected OrderRejected_var ) {
        super( OrderRejected_var );

        set_reason( OrderRejected_var.get_reason() );
        set_timeStamp( OrderRejected_var.get_timeStamp() );
    }
    ...
    */
    public Object getParameter( String datamemberName ) {
        if ( "reason".equals(datamemberName) ) return new Character(get_reason());
    ...
    protected boolean setParameterAux( String datamemberName, String val ) {
        boolean retval = true;
        if ( "reason".equals( datamemberName) ) set_reason( val.charAt(0) );
    ...
    protected boolean setParameterAux( String datamemberName, Object val ) {
        boolean retval = true;
        if ( "reason".equals( datamemberName) ) set_reason( (Character)val );
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof OrderRejected ) {
            OrderRejected data = (OrderRejected)object;
