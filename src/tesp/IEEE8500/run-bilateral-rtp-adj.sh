...
xterm -fg cyan -bg black -l -lf $logs_directory/Controller-${timestamp}.log -T "Controller" -geometry 140x40+90+120 -e "sh run.sh conf/Controller_RTP_ADJ_July7.json" &
