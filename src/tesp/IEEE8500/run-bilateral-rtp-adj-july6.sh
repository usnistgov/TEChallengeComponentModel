...
xterm -fg yellow -bg black -l -lf $logs_directory/SimulationTime-${timestamp}.log -T "SimulationTime" -geometry 140x40+30+60 -e "sh run.sh conf/SimulationTimeJuly6.json" &
...
xterm -fg cyan -bg black -l -lf $logs_directory/Controller-${timestamp}.log -T "Controller" -geometry 140x40+90+120 -e "sh run.sh conf/Controller_RTP_ADJ_July6.json" 
