...
/**
* Implements InteractionRoot.C2WInteractionRoot.RealTimePrice
*/
public class RealTimePrice extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the RealTimePrice interaction class with default parameter values.
    */
    ...
    /**
    * Returns the handle (RTI assigned) of the RealTimePrice interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the RealTimePrice interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.RealTimePrice";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the RealTimePrice interaction class.
    *
    ...
    * RealTimePrice interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.RealTimePrice");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice", RealTimePrice.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.RealTimePrice");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.RealTimePrice");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice.sourceFed", _sourceFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice.time", _time_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.RealTimePrice.value", _value_handle);
    ...
    /**
    * Publishes the RealTimePrice interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the RealTimePrice interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the RealTimePrice interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the RealTimePrice interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the RealTimePrice interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the RealTimePrice interaction class).
    ...
    */
    ...
    protected RealTimePrice( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected RealTimePrice( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the RealTimePrice interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new RealTimePrice interaction class instance
    */
    public RealTimePrice( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #RealTimePrice( ReceivedInteraction datamemberMap )}, except this
    * new RealTimePrice interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new RealTimePrice interaction class instance
    * @param logicalTime timestamp for this new RealTimePrice interaction class
    * instance
    */
    public RealTimePrice( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new RealTimePrice interaction class instance that is a duplicate
    * of the instance referred to by RealTimePrice_var.
    *
    * @param RealTimePrice_var RealTimePrice interaction class instance of which
    * this newly created RealTimePrice interaction class instance will be a
    * duplicate
    */
    public RealTimePrice( RealTimePrice RealTimePrice_var ) {
        ...
        set_value( RealTimePrice_var.get_value() );
    }
