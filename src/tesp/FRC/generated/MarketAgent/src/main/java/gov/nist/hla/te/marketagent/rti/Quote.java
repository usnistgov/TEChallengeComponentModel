...
/**
* Implements InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote
*/
public class Quote extends MarketInteraction {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the Quote interaction class with default parameter values.
    */
    public Quote() {}
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the Quote interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote";
    }
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote", Quote.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.counterPartyId", _counterPartyId_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.id", _id_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.interval", _interval_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.marketId", _marketId_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.partyId", _partyId_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.price", _price_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.quantity", _quantity_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.side", _side_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Quote.sourceFed", _sourceFed_handle);
