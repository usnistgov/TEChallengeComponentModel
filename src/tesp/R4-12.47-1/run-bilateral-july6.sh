...
cd $root_directory/FederationManagerBilateral
...
xterm -fg yellow -bg black -l -lf $logs_directory/SimulationTime-${timestamp}.log -T "SimulationTime" -geometry 140x40+30+60 -e "sh run.sh conf/SimulationTime-July6.json" &
...
cd $root_directory/Controller
xterm -fg cyan -bg black -l -lf $logs_directory/Controller-${timestamp}.log -T "Controller" -geometry 140x40+90+120 -e "sh run.sh conf/Controller-July6.json" &
