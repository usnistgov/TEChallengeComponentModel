...
xterm -fg yellow -bg black -l -lf $logs_directory/Auction-${timestamp}.log -T "Auction" -geometry 140x40+30+60 -e "sh run.sh conf/Auction-Flat.json" &
waitUntilJoined Auction 1

cd $root_directory/FileReader
xterm -fg green -bg black -l -lf $logs_directory/FileReader-${timestamp}.log -T "FileReader" -geometry 140x40+60+90 -e "sh run.sh conf/FileReader-Flat-June23.json" &
...
xterm -fg white -bg black -l -lf $logs_directory/SimulationTime-${timestamp}.log -T "SimulationTime" -geometry 140x40+120+150 -e "sh run.sh conf/SimulationTime-June23.json" &
