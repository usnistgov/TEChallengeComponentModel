...
/**
* Implements InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction
*/
public class Transaction extends MarketInteraction {
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction";
    }
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction", Transaction.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.counterPartyId", _counterPartyId_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.id", _id_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.interval", _interval_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.marketId", _marketId_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.partyId", _partyId_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.price", _price_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.quantity", _quantity_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.side", _side_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.MarketInteraction.Transaction.sourceFed", _sourceFed_handle);
