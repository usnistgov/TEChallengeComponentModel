...
xterm -fg green -bg black -l -lf $logs_directory/MarketAgent-${timestamp}.log -T "MarketAgent" -geometry 140x40+60+90 -e "sh run.sh" &
waitUntilJoined MarketAgent 1

cd $root_directory/generated/UserAgent
xterm -fg cyan -bg black -l -lf $logs_directory/UserAgent-${timestamp}.log -T "UserAgent" -geometry 140x40+90+120 -e "sh run.sh" &
