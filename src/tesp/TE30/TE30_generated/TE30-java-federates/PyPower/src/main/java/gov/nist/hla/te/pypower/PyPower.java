package gov.nist.hla.te.pypower;

import gov.nist.hla.te.pypower.rti.*;
...
// Define the PyPower type of federate for the federation.
...
public class PyPower extends PyPowerBase {
    ...
    public PyPower(FederateConfig params) throws Exception {
        ...
        //////////////////////////////////////////////////////
        // vSubstation.registerObject(getLRC());
    ...
    private void execute() throws Exception {
        ...
        while (!exitCondition) {
            ...
            ////////////////////////////////////////////////////////////
            //    vSubstation.set_distribution_load(<YOUR VALUE HERE >);
            //    vSubstation.set_name(<YOUR VALUE HERE >);
            //    vSubstation.set_positive_sequence_voltage(<YOUR VALUE HERE >);
            //    vSubstation.updateAttributeValues(getLRC(), currentTime + getLookAhead());
