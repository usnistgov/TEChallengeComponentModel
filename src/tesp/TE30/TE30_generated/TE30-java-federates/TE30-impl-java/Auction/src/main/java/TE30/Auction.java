...
public class Auction extends AuctionBase {
    ...
    private void handleObjectClass(House object) {
        ...
        //log.info("house / air_temp: {} / {}", key, object.get_air_temperature());
    }
