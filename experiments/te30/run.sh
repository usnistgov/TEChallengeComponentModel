...
xterm -fg white -bg black -l -lf $logs_directory/federation-manager-${timestamp}.log -T "Federation Manager" -geometry 140x40+100+50 -e "export CPSWT_ROOT=`pwd` && mvn exec:java -P FederationManagerExecJava" &
...
xterm -fg yellow -bg black -l -lf $logs_directory/grid-${timestamp}.log -T "Grid" -geometry 140x40+150+80 -e "sh run.sh" &
waitUntilJoined Grid 1

cd $root_directory/Metronome
xterm -fg green -bg black -l -lf $logs_directory/metronome-${timestamp}.log -T "Metronome" -geometry 140x40+200+110 -e "sh run.sh" &
